// const { Auth, AuthListener } = require("../../jl_lib/jl_auth_2.0.0")
import * as authModule from "../../jl_lib/jl_auth_2.0.0";
const { Auth, AuthListener } = authModule as any;
...
import * as watchModule from "../../jl_lib/jl-rcsp-op/jl_op_watch_1.1.0";
const { RcspOperateWrapper, OPWatchDial, OPWatch, OPSystemInfo, OPLargerFileTrans, OPFile, OPDirectoryBrowse, OPHeadSet, OPLargerFileGet } = watchModule as any;
